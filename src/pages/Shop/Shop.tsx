...
import { GetProductFilterResponseDto, GetProductVariantsByCriteriaResponseDto, PRODUCT_CATEGORY, SIZE } from 'contracts';
...
import { isProductCategory } from 'contracts/enums/product-category.ts';
import { isSize } from 'contracts/enums/size.ts';
